@extends( Auth::user() ?'layouts.app':'layouts.theme' )
@section('content')
    <div class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="logo-center ">
                <a href="{{ route('admin-login') }}" class="brand-link navbar-white ">
                    <div class="login-img2 ">
                        <img src="{{asset('assets/images/admin-logo.png') }}" class="logo-img" alt="logo">
                    </div>
                </a>
            </div>
            <div class="card">
