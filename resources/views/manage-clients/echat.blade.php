                                                                ...
                                                                <div class="form-group">
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="col-md-2 mb-3">
                                                                            <label for="category_name">Qty<span
                                                                                    class="text-danger">*</span></label>
                                                                        </div>
                                                                        <div class="col-md-2 mb-3">
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="category_name">Comment<span
                                                                                    class="text-danger">*</span></label>
                                                                        </div>
                                                                    </div>
                                                                    @foreach ($medications as $key => $med)
                                                                        <div class="form-row">
                                                                            <div class="col-md-4 ">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        class="containers">{{ $med->medication_name }}
                                                                                        <input type="checkbox"
                                                                                            name="medical_id[]"
                                                                                            value="{{ $med->id }}"
                                                                                            checked>
                                                                    ...
                                                                    <div class="form-row float-md-right col-12">
                                                                        <div class="col-md-3 mb-3">
                                                                            <div class="form-group">
                                                                                <label for="category_name">Staff
                                                                                    Signature</label>
                                                                                <canvas id="signature1" class="signature"
                                                                                    height="90"
                                                                                ...
                                                                                <img src='' id='sign_prev1'
                                                                                    style='display: block;' />
                                                                                <input type="hidden" class="form-control"
                                                                                    id="staff_signature"
                                                                                    name="staff_signature">
                                                                                <small
                                                                                    class="text-danger">{{ $errors->first('staff_id') }}</small>
                                                                            </div>
